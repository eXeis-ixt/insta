...
<template>
    <div id="MainLayout" class="w-full h-screen">
        ...
        >
            ...
            >
                ...
                <div class="max-w-[300px] mt-5">
                    <div class="text-sm text-gray-400">This website is developed only for learning purposes</div>
        ...
        <div id="bottomNav" class="fixed z-30 bottom-0 w-full md:hidden flex items-center justify-around bg-white border-t py-2 border-t-gray-300">
            ...
            <Link>
            <HomeOutline fillColor="#000000" class=" cursor-pointer" />
            ...
            <Link href="/">
                <img src="https:picsum.photos/id/50/300/320" class=" rounded-full w-[30px] cursor-pointer" alt="">
            </Link>
